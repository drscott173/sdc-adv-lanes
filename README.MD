...
of our processing steps ith images and videos.   The code can be seen in project.py.  We captured a snapshot of our experiments in Experiments.html and our final
